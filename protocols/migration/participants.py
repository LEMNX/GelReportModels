...
class MigrationParticipants100To104SNAPSHOT(BaseMigration):
    ...
    def migrate_cancer_participant(self, cancer_participant):
        ...
        migrated_participant.tumourSamples = self.migrate_tumour_samples(cancer_participant.tumourSamples)
        migrated_participant.germlineSamples = self.migrate_germline_samples(cancer_participant.germlineSamples)
    ...
    def migrate_tumour_sample(self, tumour_sample):
        ...
        migrated_tumour_sample.LDPCode = ''
    ...
    def migrate_germline_sample(self, germline_sample):
        ...
        migrated_germline_sample.LDPCode = ''
